...
public class RecordEntity extends PanacheEntityBase {
  ...
  /**
   * Minor units, exact under addition. See {@link prudent.account.AccountBalance} for why
  ...
  /**
   * The net of one account's records, by currency — what {@link prudent.account.AccountMapper}
   ...
   * {@link prudent.account.AccountMapper} uses to answer {@code GET /api/v1/accounts}
   ...
   * {@link prudent.AnalyticsResource}'s two endpoints. Each row is
