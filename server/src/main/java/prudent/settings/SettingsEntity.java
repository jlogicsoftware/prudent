 ...
 *
 * <p>The row is created on first login by {@link prudent.NewUserSetup}, never by
 * a client.
 */
@Entity
...
public class SettingsEntity extends PanacheEntityBase {
   ...
   * {@link prudent.account.AccountEntity}.
   */
  @Id
  @Column(name = "user_id")
  public UUID userId;
   ...
   * request resolves to, and the value {@link prudent.NewUserSetup} writes for a
